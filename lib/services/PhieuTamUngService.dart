...
class PhieuTamUngService{
  ...
  Future<void> addPhieuTamUng(PhieuTamUng phieuTamUng) async {
    await _phieuTamUngCollection.add(phieuTamUng.toMap());
  }

  Future<void> updatePhieuTamUng(String id, PhieuTamUng phieuTamUng) async {
    await _phieuTamUngCollection.doc(id).update(phieuTamUng.toMap());
  }
