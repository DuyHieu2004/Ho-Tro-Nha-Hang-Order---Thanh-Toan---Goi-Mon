...
class DonDatChoService{
  ...
  Future<void> addDonDatCho(DonDatCho donDatCho) async {
    await _donDatChoCollection.add(donDatCho.toMap());
  }

  Future<void> updateDonDatCho(String id, DonDatCho donDatCho) async {
    await _donDatChoCollection.doc(id).update(donDatCho.toMap());
  }
