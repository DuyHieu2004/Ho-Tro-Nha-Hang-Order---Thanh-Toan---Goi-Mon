              ...
              child: ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder:
                          (context) => Info_Screen(nhanVien: widget.nhanVien),
                    ),
                  );
                },
              ),
                    ...
                    children: <Widget>[
                      Expanded(
                        child: FutureBuilder<int>(
                          future:
                              _todayOrderCount, // Sử dụng Future đã khởi tạo
